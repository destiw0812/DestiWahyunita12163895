                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div id="submenu-1-2" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{ url('/suplier') }}">Supplier</a>
                                                    </li>
                                                    <!-- <li class="nav-item">
                                                        <a class="nav-link" href="{{ url('/invoice.index') }}">Tabel Invoice</a>
                                                    </li>
													<li class="nav-item">
                                                        <a class="nav-link" href="{{ url('/invoice.create') }}">Buat Invoice</a>
                                                    </li> -->
                                                </ul>
                                            </div>
                                        </li>
