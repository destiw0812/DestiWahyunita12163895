...
Route::group(['prefix' => 'suplier'], function() {
    ...
    Route::get('/new', 'SuplierController@create');
    Route::post('/', 'SuplierController@save');
    Route::get('/{id}', 'SuplierController@edit');
    Route::put('/{id}', 'SuplierController@update');
    Route::delete('/{id}', 'SuplierController@destroy');
});
